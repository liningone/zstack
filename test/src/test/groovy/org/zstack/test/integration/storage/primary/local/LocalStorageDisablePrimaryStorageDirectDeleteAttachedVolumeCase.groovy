 ...
 */
class LocalStorageDisablePrimaryStorageDirectDeleteAttachedVolumeCase extends SubCase{
    EnvSpec env
    ...
    void test() {
        env.create {
            testLocalStorageDirectDeleteAttachedVolumeWhenPrimaryStorageIsDisabled()
        }
    }


    void testLocalStorageDirectDeleteAttachedVolumeWhenPrimaryStorageIsDisabled() {
