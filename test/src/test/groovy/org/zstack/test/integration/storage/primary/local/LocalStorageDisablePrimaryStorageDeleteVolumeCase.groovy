 ...
 */
class LocalStorageDisablePrimaryStorageDeleteVolumeCase extends SubCase{
    EnvSpec env
    ...
    void test() {
        env.create {
            testLocalStorageDeleteVolumeWhenPrimaryStorageIsDisabled()
        }
    }

    void testLocalStorageDeleteVolumeWhenPrimaryStorageIsDisabled() {
